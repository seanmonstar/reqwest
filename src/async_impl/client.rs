...
impl ClientBuilder {
    ...
    pub fn build(self) -> crate::Result<Client> {
        ...
        let retries = tower::retry::Retry::new(retry_policy, hyper_service);
            ...
            inner: Arc::new(ClientRef {
                ...
                h3_client: match h3_connector {
                    Some(h3_connector) => {
                        ...
                        Some(FollowRedirect::with_policy(h3_service, redirect_policy))
                    }
                    None => None,
                },
    ...
    ///
    /// Default retries protocol NACKs.
...
type LayeredService<T> = FollowRedirect<tower::retry::Retry<crate::retry::Policy, T>, TowerRedirectPolicy>;
