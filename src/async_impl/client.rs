...
impl ClientBuilder {
    ...
    pub fn build(self) -> crate::Result<Client> {
        ...
        // Windows Named Pipe support, placed next to UDS for clarity
        #[cfg(target_os = "windows")]
