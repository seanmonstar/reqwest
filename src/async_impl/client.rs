...
use crate::dns::hickory_dns::HickoryDnsResolver;
...
impl ClientBuilder {
    ...
    #[deprecated(since = "0.11.22", note = "trust_dns was replaced by hickory_dns. Users should instead use hickory_dns")]
    #[inline]
    ...
    #[deprecated(since = "0.11.22", note = "no_trust_dns was replaced by no_hickory_dns. Users should instead use no_hickory_dns")]
    #[inline]
